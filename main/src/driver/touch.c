...
esp_lcd_touch_handle_t touch_controller_init(void) {
...
#if defined(CONFIG_LCD_TOUCH_CONTROLLER_STMPE610)
  esp_lcd_panel_io_spi_config_t tp_io_config =
      ESP_LCD_TOUCH_IO_SPI_STMPE610_CONFIG(CONSTANT_PIN_NUM_TOUCH_CS);
#elif defined(CONFIG_LCD_TOUCH_CONTROLLER_XPT2046)
  esp_lcd_panel_io_spi_config_t tp_io_config =
      ESP_LCD_TOUCH_IO_SPI_XPT2046_CONFIG(CONSTANT_PIN_NUM_TOUCH_CS);
#else
  ...
  esp_lcd_touch_config_t tp_cfg = {
      .x_max = CONSTANT_LCD_H_RES,
      .y_max = CONSTANT_LCD_V_RES,
      .rst_gpio_num = -1,
      .int_gpio_num = -1,
      .flags =
          {
